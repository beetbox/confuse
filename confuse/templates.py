...
class MappingTemplate(Template):
    ...
    def __repr__(self):
        return f"MappingTemplate({repr(self.subtemplates)})"
...
class Sequence(Template):
    ...
    def __repr__(self):
        return f"Sequence({repr(self.subtemplate)})"
...
class MappingValues(Template):
    ...
    def __repr__(self):
        return f"MappingValues({repr(self.subtemplate)})"
...
class OneOf(Template):
    ...
    def convert(self, value, view):
        ...
        self.fail(f"must be one of {repr(self.allowed)}, not {repr(value)}", view)
...
class Optional(Template):
    ...
    def __repr__(self):
        return (
            f"Optional({repr(self.subtemplate)}, {repr(self.default)}, "
